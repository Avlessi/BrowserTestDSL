...
/**
 * This is the item provider adapter for a {@link org.xtext.example.browser.browser.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_link_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_link_feature", "_UI_Link_type"),
				 BrowserPackage.Literals.LINK__LINK,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Link)object).getLink();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Link.class)) {
			case BrowserPackage.LINK__LINK:
