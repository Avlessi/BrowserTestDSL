...
/**
 * This is the item provider adapter for a {@link org.xtext.example.browser.browser.GoTo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoToItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GoTo_v_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GoTo_v_feature", "_UI_GoTo_type"),
				 BrowserPackage.Literals.GO_TO__V,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BrowserPackage.Literals.GO_TO__LINK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BrowserPackage.Literals.GO_TO__LINK,
