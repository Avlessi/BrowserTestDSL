...
/**
 * This is the item provider adapter for a {@link org.xtext.example.browser.browser.Procedure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcedureItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BrowserPackage.Literals.PROCEDURE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BrowserPackage.Literals.PROCEDURE__PARAMS);
			childrenFeatures.add(BrowserPackage.Literals.PROCEDURE__INS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BrowserPackage.Literals.PROCEDURE__PARAMS,
				 BrowserFactory.eINSTANCE.createParameters()));

		newChildDescriptors.add
			(createChildParameter
				(BrowserPackage.Literals.PROCEDURE__INS,
