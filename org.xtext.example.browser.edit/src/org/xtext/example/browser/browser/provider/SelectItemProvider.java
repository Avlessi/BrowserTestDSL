...
/**
 * This is the item provider adapter for a {@link org.xtext.example.browser.browser.Select} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SelectItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Select_v_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Select_v_feature", "_UI_Select_type"),
				 BrowserPackage.Literals.SELECT__V,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BrowserPackage.Literals.SELECT__SB);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BrowserPackage.Literals.SELECT__SB,
