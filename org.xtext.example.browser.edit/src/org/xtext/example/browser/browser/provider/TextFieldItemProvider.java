...
/**
 * This is the item provider adapter for a {@link org.xtext.example.browser.browser.TextField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextFieldItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextField_username_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextField_username_feature", "_UI_TextField_type"),
				 BrowserPackage.Literals.TEXT_FIELD__USERNAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((TextField)object).getUsername();
