...
/**
 * This is the item provider adapter for a {@link org.xtext.example.browser.browser.Fill} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FillItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fill_v_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fill_v_feature", "_UI_Fill_type"),
				 BrowserPackage.Literals.FILL__V,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addInputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fill_input_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fill_input_feature", "_UI_Fill_type"),
				 BrowserPackage.Literals.FILL__INPUT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BrowserPackage.Literals.FILL__TF);
			childrenFeatures.add(BrowserPackage.Literals.FILL__PASS);
		}
	...
	public String getText(Object object) {
		String label = ((Fill)object).getInput();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BrowserPackage.Literals.FILL__TF,
				 BrowserFactory.eINSTANCE.createTextField()));

		newChildDescriptors.add
			(createChildParameter
				(BrowserPackage.Literals.FILL__PASS,
