...
/**
 * This is the item provider adapter for a {@link org.xtext.example.browser.browser.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_button_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_button_feature", "_UI_Button_type"),
				 BrowserPackage.Literals.BUTTON__BUTTON,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Button)object).getButton();
